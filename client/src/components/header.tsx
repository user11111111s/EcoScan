...
import { Search, Heart, Moon, Sun, User } from "lucide-react";
    ...
    <header className="sticky top-0 z-30 w-full bg-white dark:bg-slate-800 shadow-sm">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Button variant="ghost" size="icon" className="bg-gray-200 dark:bg-slate-600 rounded-full" aria-label="User profile">
